...
class Game {
    ...
    handleGameResult() {
        ...
        axios
            .get("https://script.google.com/a/g.ntu.edu.tw/macros/s/AKfycbwwNUeevxFlQaLzP_gdhnTmSC97HgRlpV6DOCUIzg/exec", {
                params: {
                    name,
                    level,
                    battery,
    ...
    handleGameStars() {
            axios
                .get("https://script.google.com/a/g.ntu.edu.tw/macros/s/AKfycbx1L2GmotaRfoSMzVA5BtpC9kiWneoA69IOtoEi/exec")
                .then(res => {
                    const data = res.data;
